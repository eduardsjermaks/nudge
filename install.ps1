...
Write-Host ""
Write-Host "It installs Ollama via winget (or configures a cloud provider instead),"
Write-Host "pulls the model, and adds the PowerShell hook - asking before every change."
